...
pub enum NimbusNodeRole { Primary, Secondary, Observer, Guardian, BootstrapNode }
...
impl NimbusCluster {
    pub fn new(consensus_threshold: f64) -> Self {
        NimbusCluster { nodes: std::collections::HashMap::new(), consensus_threshold }
    }
...
impl Default for NimbusCluster { fn default() -> Self { Self::new(0.67) } }
