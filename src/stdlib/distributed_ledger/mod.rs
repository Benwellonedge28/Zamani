...
pub mod data_provenance; // New: Verifiable Data Provenance & Ethical AI
...
pub fn init_ledger() {
    ...
    contract_engine::init_contract_engine();
    data_provenance::init_data_provenance(); // Initialize Data Provenance
