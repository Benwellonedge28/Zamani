...
// includes: {}",
    ...
    pub fn record(&mut self, event: &str, ts: u64) {
        self.events.push(Telemetry {
            event: event.into(),
            metadata: HashMap::new(),
            ts,
        });
    }
    pub fn generate_docs(&self, module: &str) -> String {
        format!(
            "# {} Documentation
