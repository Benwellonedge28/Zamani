# Zamani ANTLR4 Grammar

`Zamani.g4` is a standalone ANTLR4 grammar for the Zamani language, generated
...
accept/reject behavior against the actual `zamani` binary on the same input.
...
- The reference parser treats several reserved keywords (`this`, `self`,
  primitive type names, Zamani-native domain keywords) as valid identifiers
