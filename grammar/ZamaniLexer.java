...
public class ZamaniLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__217", "T__218", "T__219", "T__220", "T__221", "T__222", "ORBITAL", 
			"FORMULA", "OPERATOR", "MODULE", "IMPORT", "EXPORT", "AS", "USE", "GLOBAL", 
			"USING", "FN", "PUB", "PRIVATE", "PROTECTED", "STATIC", "CONST", "ASYNC", 
			"UNSAFE", "INLINE", "OVERRIDE", "FINAL", "ABSTRACT", "VIRTUAL", "SEALED", 
			"PARTIAL", "FILE", "REQUIRED", "INIT", "RETURN", "BREAK", "CONTINUE", 
			"WHILE", "FOR", "IN", "LOOP", "IF", "ELSE", "MATCH", "CASE", "WHEN", 
			"THROW", "TRY", "CATCH", "FINALLY", "LET", "VAR", "TYPE", "STRUCT", "ENUM", 
			"TRAIT", "IMPL", "CLASS", "INTERFACE", "RECORD", "QUANTUM", "CIRCUIT", 
			"MEASURE", "RESET", "BARRIER", "THIS", "SELF_LOWER", "SELF_UPPER", "INT_KW", 
			"FLOAT_KW", "BOOL_KW", "STR_KW", "STRING_KW", "CHAR_KW", "VOID", "NANO", 
			"AGENT", "EFFECT", "HANDLE", "REMEMBER", "RECALL", "LEARN", "INFER", 
			"WISDOM", "ZAMANI", "SASA", "ANCESTOR", "LINEAR", "AFFINE", "LANGUAGE", 
			"MTS_KW", "LEN", "PRINT", "PRINTLN", "ASSERT", "PANIC", "TRUE", "FALSE", 
			"NIL_KW", "NULL_KW", "BOOLEAN", "NIL", "INTEGER", "FLOAT", "STRING", 
			"CHAR", "QUANTUM_LITERAL", "NANO_ANNOTATION", "MTS_LITERAL", "IDENT", 
			"LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "COMMA", 
			"DOT", "SEMI", "COLON", "ARROW", "FATARROW", "COLONCOLON", "TILDE", "HASH", 
			"AT", "BANG", "PLUS", "MINUS", "STAR", "SLASH", "PERCENT", "ASSIGN", 
			"EQ", "NEQ", "LT", "GT", "LE", "GE", "ANDAND", "OROR", "AMP", "PIPE", 
			"CARET", "SHL", "SHR", "SHRU", "PLUSEQ", "MINUSEQ", "STAREQ", "SLASHEQ", 
			"DOTDOT", "DOTDOTEQ", "QUESTION", "DOLLAR", "LINE_COMMENT", "BLOCK_COMMENT", 
			"DOC_COMMENT", "WS", "ALPHA", "DIGIT", "HEX_DIGIT", "BIN_DIGIT", "OCT_DIGIT", 
			"ESC"
		};
	}
	...
	public ZamaniLexer(CharStream input) {
		super(input);
